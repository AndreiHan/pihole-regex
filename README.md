...
### Add to Pi-Hole
```
curl -sSl https://raw.githubusercontent.com/AndreiHan/pihole-regex/blob/master/install.py | sudo python3
```

### Remove from Pi-Hole
```
curl -sSl https://raw.githubusercontent.com/AndreiHan/pihole-regex/blob/master/uninstall.py | sudo python3
```
...
30 2 * * 1 /usr/bin/curl -sSl https://raw.githubusercontent.com/AndreiHan/pihole-regex/blob/master/install.py | /usr/bin/python3
```
3. Save changes
